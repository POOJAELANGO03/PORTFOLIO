      ...
      <div className="container">
        <div className="section-header">
          ...
          <p className="section-subtitle">
           Big ideas often start small—like a simple 'Hi'
          </p>
        </div>

        <div className="contact-content">
          <div className="contact-info">
            <div className="contact-card glass glow">
              <h3>Let's Connect</h3>
              <p>
               Whether it’s shaping bold ideas or geeking out on design, I’m just one message away.
              </p>
              ...
              <div className="contact-methods">
                <div className="contact-method">
                  ...
                  <div className="method-info">
                    <h4>Email</h4>
                    <a href="mailto:poojaelango03@gmail.com">poojaelango03@gmail.com</a>
                  </div>
                </div>
                ...
                <div className="contact-method">
                  ...
                  <div className="method-info">
                    <h4>Phone</h4>
                    <a href="tel:+919363090781">+919363090781</a>
                  </div>
                </div>
